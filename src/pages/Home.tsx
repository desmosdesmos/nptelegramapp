      ...
      <div className="w-full max-w-sm mx-auto grid grid-cols-2 gap-4 mt-6"> {/* Added mt-6 for separation */}
        ...
        <ScaleButton>
          <div 
            ...
            className="relative flex flex-col items-center justify-center p-4 aspect-square bg-gray-700 rounded-2xl cursor-pointer"
          >
        ...
        <ScaleButton>
          <div 
            ...
            className="relative flex flex-col items-center justify-center p-4 aspect-square bg-[rgba(255,255,255,0.05)] backdrop-blur-md border border-[rgba(255,255,255,0.1)] rounded-2xl cursor-pointer"
          >
            <span className="absolute text-[6rem] opacity-30 top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2">📸</span>
