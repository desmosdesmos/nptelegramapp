...
import { getReferralCounts, getReferralDetails } from '../utils/simpleReferralSystem';
  ...
  return (
    <div className={`w-full p-6 rounded-2xl bg-gradient-to-br from-indigo-500 to-purple-600 shadow-xl relative overflow-hidden ${className}`}>
      ...
      <div className="relative z-10">
        ...
        <p className="text-white/80 mb-6">Приведи друга на комплексную химчистку и получи 300₽ на карту!<br/>После перехода по ссылке другу нужно нажать на кнопку "NP Fast" в чате с ботом.</p>
