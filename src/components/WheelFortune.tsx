...
const FullScreenResult = () => {
  ...
  return (
    <div className="fixed inset-0 bg-black/70 backdrop-blur-2xl flex items-center justify-center z-50 p-4" style={{ outline: '2px solid red' }}>
      <div className="bg-[#0a0a0a]/85 rounded-3xl p-8 max-w-md w-full border border-white/10 shadow-lg shadow-black/20 text-center" style={{ outline: '2px solid orange' }}>
        <div className="mb-6" style={{ outline: '2px solid yellow' }}>
          <div className="inline-flex items-center justify-center w-24 h-24 rounded-full bg-black/20 border border-white/10 mb-6" style={{ outline: '2px solid green' }}>
            <span className="text-5xl" style={{ outline: '2px solid blue' }}>🎉</span>
          </div>
          <h2 className="text-3xl font-bold text-white mb-1 font-system" style={{ outline: '2px solid purple' }}>Поздравляем!</h2>
          <p className="text-cyan-300 font-system text-sm" style={{ outline: '2px solid pink' }}>Вы выиграли:</p>
        </div>

        <div className="mb-8" style={{ outline: '2px solid cyan' }}>
          <div
          ...
          <p className="text-white/80 text-lg font-system leading-relaxed" style={{ outline: '2px solid magenta' }}>
